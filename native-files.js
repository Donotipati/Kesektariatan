(function () {
  ...
  var EASY_LOCATION = "Internal storage/Download/Kesekretariatan";
  var FALLBACK_LOCATION = "Internal storage/Android/data/id.kesekretariatan.app/files/Kesekretariatan";
  ...
  async function saveOrShareBlob(filename, blob, opts){
    ...
    if(fs){
      try{
        var relPath = "Kesekretariatan/" + filename;
